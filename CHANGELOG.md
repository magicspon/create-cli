...
- [#19](https://github.com/magicspon/create-cli/pull/19) [`8c5e3b1`](https://github.com/magicspon/create-cli/commit/8c5e3b1f01eecf3489e13b87858c66f84ea807f9) Thanks [@magicspon](https://github.com/magicspon)! - `scaffold kit new` now seeds a kit with a copy of the built-in templates rather than one starter
